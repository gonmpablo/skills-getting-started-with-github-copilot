...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve fundamentals, teamwork, and game strategy",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "mason@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore watercolor and acrylic techniques with guided projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["mia@mergington.edu", "lucas@mergington.edu"]
    },
    "School Choir": {
        "description": "Group vocal training and performances at school events",
